    ...
    <div className='max-w-7xl mx-auto w-full mt-5 col-span-2'>
      ...
      <div className='px-5 [1300px]:px-0 w-full grid grid-cols-1 mt-5'>
        ...
        <div className='mt-3 flex flex-col col-span-2 md:grid md:grid-cols-2 md:mb-6'>
          ...
          <div className='lg:col-start-2 lg:col-end-3 break-words'>{offer.description}</div>
        </div>
        <hr className='hidden md:block mb-3 col-span-2' />
        ...
        <div className='mt-3 flex flex-col col-span-2 md:grid md:grid-cols-2 md:mb-6'>
          ...
          <ul className='list-disc pl-7'>
            {changeStringIntoArray(offer.obligation).map(
              (obligation, index) => (
                <li key={index} className='break-words'>{obligation}</li>
              )
            )}
          </ul>
        </div>
        ...
        <div className='mt-3 flex flex-col col-span-2 md:grid md:grid-cols-2 md:mb-6'>
          ...
          <ul className='list-disc pl-7'>
            {changeStringIntoArray(offer.requirements).map(
              (requirement, index) => (
        ...
        <div className='mt-3 flex flex-col col-span-2 md:grid md:grid-cols-2 md:mb-6'>
          ...
          <ul className='list-disc pl-7'>
            {changeStringIntoArray(offer.advantages).map((advantage, index) => (
              <li key={index} className='break-words'>{advantage}</li>
            ))}
          </ul>
        </div>
        <hr className='hidden md:block mb-3 col-span-2' />
        ...
        <div className='mt-3 flex flex-col col-span-2 md:grid md:grid-cols-2 md:mb-6'>
          ...
          <ul className='list-disc pl-7'>
            {changeStringIntoArray(offer.benefits).map((benefit, index) => (
