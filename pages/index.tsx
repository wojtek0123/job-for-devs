  ...
  return (
    <>
      <div className='w-full bg-white flex flex-col items-center justify-center md:pt-10 rounded-b-lg pb-3 px-5 2xl:px-0'>
        <h2 className='text-black my-3 text-4xl font-light md:mb-8 md:mt-0 md:text-5xl text-center'>
        ...
        >
          <input
            ...
            id='title'
            className='border border-gray-200 my-2 p-5 lg:p-3 rounded-lg w-full max-w-xl mx-auto text-lg md:my-0 md:mx-2 outline-green-500'
          ...
          <button
            ...
            className='flex items-center text-lg justify-center rounded-lg p-5 lg:p-3 bg-gray-200 text-black ml-2 max-w-xl min-w-max hover:bg-gray-300 transition-colors duration-300'
          >
            ...
            <span className='ml-2 capitalize'>Szukaj</span>
          </button>
        </form>
        <button
          type='button'
          className='bg-green-500 text-white p-5 sm:mx-5 text-lg w-full sm:max-w-md rounded-lg lg:hidden hover:bg-green-600 transition-colors duration-300'
